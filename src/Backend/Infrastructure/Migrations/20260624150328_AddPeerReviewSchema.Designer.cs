...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260624150328_AddPeerReviewSchema")]
    partial class AddPeerReviewSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.Criterion", b =>
                {
                    ...
                    b.Property<bool>("IsHiddenUntilVisibility")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.FinalGrade", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("FinalGradeString")
                        .HasMaxLength(50)
                    ...
                    b.Property<string>("TeacherOverrideComment")
                        .HasMaxLength(2000)
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.Post", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CriteriaVisibilityAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<int?>("ReviewTimeLimitMinutes")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("TeacherCanEditPeerScores")
                        .HasColumnType("boolean");

                    b.Property<string>("TeamReviewPolicy")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.Review", b =>
                {
                    ...
                    b.Property<bool>("ReplacedByTeacher")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.ReviewAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.Subject", b =>
                {
                    ...
                    b.Property<int?>("DefaultReviewTimeLimitMinutes")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid?>("FinalGradeScaleId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("LiveReviewMode")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("PeerReviewDeadlinePolicy")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<string>("PeerReviewMode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("PeerReviewScope")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.Property<bool>("ShowCriteriaBeforeDeadline")
                        .HasColumnType("boolean");

                    b.Property<string>("TeacherFinalMode")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.Team", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("RepresentativeAssignedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("RepresentativeUserId")
                        .HasColumnType("uuid");

                    b.Property<string>("ReviewParticipationPolicy")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.CriterionResult", b =>
                {
                    ...
                    b.HasOne("Infrastructure.Persistence.Entities.Review", "Review")
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.Review", b =>
                {
                    b.HasOne("Infrastructure.Persistence.Entities.ReviewAssignment", "Assignment")
                        .WithMany("Reviews")
                        .HasForeignKey("AssignmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Infrastructure.Persistence.Entities.Team", b =>
                {
                    ...
                    b.HasOne("Infrastructure.Identity.ApplicationUser", "Representative")
                        .WithMany()
