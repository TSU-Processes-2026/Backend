        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_auth_sessions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignmentData = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_subject_participants", x => new { x.SubjectId, x.UserId });
                    table.ForeignKey(
                        name: "FK_subject_participants_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_subject_participants_subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionData = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_assignment_questions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_assignment_questions_posts_AssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_assignment_question_options_assignment_questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    selectedOptionsId = table.Column<List<Guid>>(type: "uuid[]", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_answer_items_assignment_questions_assignmentQuestionId",
                        column: x => x.assignmentQuestionId,
                        principalTable: "assignment_questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_answer_items_submissions_submissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    verdictedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_answer_items_assignmentQuestionId",
                table: "answer_items",
                column: "assignmentQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_answer_items_submissionId",
                table: "answer_items",
                column: "submissionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_assignment_question_options_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subject_participants_UserId",
                table: "subject_participants",
                column: "UserId");
