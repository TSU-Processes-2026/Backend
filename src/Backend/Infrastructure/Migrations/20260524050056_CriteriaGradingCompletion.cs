...
{
    public partial class CriteriaGradingCompletion : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<Guid>(
                name: "FinalGradeScaleId",
                table: "subjects",
                type: "uuid",
                nullable: true);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinPoints = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    MaxPoints = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_course_grades_CourseId_StudentId",
                table: "course_grades",
